...
-   We should join the two data frames using the country name variable: from the population data frame we can use country and from the continents data frame we use entity.
...
-   We need to keep all the rows from population and bring in continent information from the continents data frame so we should use: left_join().
...
-   Order the continents from highest to lowest population.

-   Could have different colors to each continent for organization and clarity.

-   Could add a legend with exact values for each population.
